...
import { HeroBannerConfig } from '@/components/application/app-navigation-admin4/sidebar-navigation/tertiary-sidebar/widget-configs/hero-banner-config';
import { Button } from '@/components/base/buttons/button';
import { ButtonGroup, ButtonGroupItem } from '@/components/base/button-group/button-group';
import { Phone01, Tablet01, Monitor01, FlipBackward, FlipForward, Sun, Moon01 } from '@untitledui/icons';

const HeroBannerCustomizePage = () => {
  ...
  const configSidebar = useMemo(() => <HeroBannerConfig />, []);
  ...
  const handleSave = () => {
    console.log('Save hero banner config');
  };
  ...
  return (
    <CustomizerLayout
      sidebarTitle="Configure Hero Banner"
      sidebarDescription="Configure hero banner settings and appearance"
...
export default HeroBannerCustomizePage;
