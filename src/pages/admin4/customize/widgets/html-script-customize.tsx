...
import { HtmlScriptConfig } from '@/components/application/app-navigation-admin4/sidebar-navigation/tertiary-sidebar/widget-configs/html-script-config';
import { Button } from '@/components/base/buttons/button';
import { ButtonGroup, ButtonGroupItem } from '@/components/base/button-group/button-group';
import { Phone01, Tablet01, Monitor01, FlipBackward, FlipForward, Sun, Moon01 } from '@untitledui/icons';

const HtmlScriptCustomizePage = () => {
  ...
  const configSidebar = useMemo(() => <HtmlScriptConfig />, []);
  ...
  const handleSave = () => {
    console.log('Save HTML script config');
  };
  ...
  return (
    <CustomizerLayout
      sidebarTitle="Configure HTML Script"
      sidebarDescription="Add custom HTML, CSS, and JavaScript code"
    ...
    >
      <div className="p-4">
        ...
        <BrowserMockup url="http://yoursite.com/space" title="HTML Script Preview" theme={selectedTheme as 'light' | 'dark'} device={selectedDevice as 'mobile' | 'tablet' | 'desktop'} />
      </div>
    </CustomizerLayout>
  );
};

export default HtmlScriptCustomizePage;
