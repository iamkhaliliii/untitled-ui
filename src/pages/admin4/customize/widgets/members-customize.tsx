...
import { MembersConfig } from '@/components/application/app-navigation-admin4/sidebar-navigation/tertiary-sidebar/widget-configs/members-config';
import { Button } from '@/components/base/buttons/button';
import { ButtonGroup, ButtonGroupItem } from '@/components/base/button-group/button-group';
import { Phone01, Tablet01, Monitor01, FlipBackward, FlipForward, Sun, Moon01 } from '@untitledui/icons';

const MembersCustomizePage = () => {
  ...
  const configSidebar = useMemo(() => <MembersConfig />, []);
  ...
  const handleSave = () => {
    console.log('Save members config');
  };
  ...
  return (
    <CustomizerLayout
      sidebarTitle="Configure Members"
      sidebarDescription="Configure members widget settings and appearance"
...
export default MembersCustomizePage;
