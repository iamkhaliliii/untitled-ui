...
export const SiteSpacesHelpPage = () => {
    ...
    // Render content permissions for help page
    ...
    const getPageTitle = () => {
        ...
        if (currentPath.includes("/analytics")) return "View help analytics and insights";
        if (currentPath.includes("/audit-logs")) return "View help audit logs and activity";
        ...
        if (currentPath.includes("/admin4/site/spaces/growth/help")) return "Manage and organize help articles in your growth workspace";
