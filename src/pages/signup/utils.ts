...
export const generatePlanRecommendationText = (formData: SignupFormData, recommendedPlan: string, brandData?: BrandData | null) => {
  ...
  const templates = {
    ...
    growth: `##**Time to amplify your ${industry.toLowerCase()} leadership, ${name}.**\n\n**${company}** is ready to unlock serious community ROI. Your **${companySize}-person** team, combined with ${integrationIconsText} and more, positions you perfectly for the {{Growth}} plan's advanced capabilities.\n\nTransform scattered touchpoints into systematic advocacy that drives measurable revenue growth and competitive advantage.\n\n[[Mo Malayeri]]\n((CEO at Bettermode))`,
    
    enterprise: `##**Scale with enterprise confidence, ${name}.**\n\n**${company}** deserves community infrastructure that matches your ambitions. With your **${companySize}-person** organization using ${integrationIconsText} and more, the {{Enterprise}} plan delivers the security and scale you need.\n\nLead your **${industry.toLowerCase()}** with community strategies that enterprise customers trust and competitors can't match.\n\n[[Mo Malayeri]]\n((CEO at Bettermode))`
  };
